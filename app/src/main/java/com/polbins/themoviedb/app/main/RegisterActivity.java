...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.polbins.themoviedb.R.layout.activity_register);

        mEmailView = (EditText) findViewById(com.polbins.themoviedb.R.id.Remail);
        mRFnameView = (EditText) findViewById(com.polbins.themoviedb.R.id.RFname);
        mRLnameView = (EditText) findViewById(com.polbins.themoviedb.R.id.RLname);
        mUsernameView = (EditText) findViewById(com.polbins.themoviedb.R.id.Rname);
        mSPasswordView = (EditText) findViewById(com.polbins.themoviedb.R.id.RSpassword);
        mAuth = FirebaseAuth.getInstance();

        mPasswordView = (EditText) findViewById(com.polbins.themoviedb.R.id.Rpassword);

        Register = (Button) findViewById(com.polbins.themoviedb.R.id.Rbutton);
